    ...
    <div class="w-full  text-cyan-800 flex">
        ...
        <div class="w-5/6 py-20 px-5">
            ...
            <div class="flex justify-between">
                ...
                <button class="ann-button px-5 rounded-lg text-white bg-emerald-plus hover:bg-emerald-light hover:scale-110">Add
                    User</button>
            </div>
            <hr class="my-5">
            <!-- head table -->
            ...
            <div v-else class="ann-item grid grid-cols-14 my-5 bg-white h-20 rounded-xl shadow-md" v-for="(user, index) in users"
                :key="user.id">
                ...
                <div class="my-auto col-span-2 flex justify-center">
                    <button
                        class="ann-button text-orange-400 bg-orange-100 hover:bg-orange-200 hover:scale-110  rounded-lg w-16 h-12 shadow-sm mx-2">Edit</button>
                    <button
